 ...
 * <p>
 * 问题转化：
 * 明显，精灵球和体力都是开销，而每个小精灵对应的价值都为1（只），所以这是一个二维费用背包问题。
 * 转化过来就是在使用n个精灵球且总价值最大时，R取最大值的情况。
 * 一维背包只花费背包的体积
 * 这个二维背包,
 * 花费:精灵球数量和皮卡丘体力值
 * 需要花两个东西
 ...
 * 最多收服的小精灵数量:f[K,N,M]
 * 最少耗费体力怎么计算呢:f[K,N,m]==f[K,N,M],满足该条件并使得m最小
 * 其实是01背包问题可以三维优化二维
 */
public class 二维费用背包收服小精灵 {
    public static void main(String[] args) {
        ...
        //如果收付k个精灵,只花费M-1体力也行,或者M-2...,找最小的那个花费,但收付的精灵数量不变
